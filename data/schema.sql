...
('p1', 'cat_choco', 'Belgian Dark Choco Melt Box', 'belgian-dark-choco-melt', 'Lapisan sponge cake cokelat lembut berpadu dengan chocolate mousse premium asal Belgia, ganache dark chocolate leleh, dan taburan choco chips krispi.', 'Dark chocolate mousse Belgia dengan melted ganache', 48000, 58000, 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=600&q=80', 'Best Seller 🔥', 'Simpan chiller (suhu 2-6°C). Tahan 4-5 hari.', 1, 1726500000000),
('p2', 'cat_coffee', 'Classic Venetian Tiramisu Box', 'classic-venetian-tiramisu', 'Tiramisu otentik dengan ladyfingers yang dicelupkan ke dalam single-origin espresso aromatik, dilapisi krim keju mascarpone lembut dan taburan bubuk kakao murni.', 'Espresso dipped ladyfingers & mascarpone cheese lembut', 52000, 62000, 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&w=600&q=80', 'Chef Choice ⭐', 'Simpan chiller. Nikmati selagi dingin untuk sensasi melt-in-mouth.', 1, 1726500000000),
('p3', 'cat_cheese', 'Lotus Biscoff Caramel Velvet', 'lotus-biscoff-caramel-velvet', 'Perpaduan biskuit Lotus Biscoff renyah di dasar box, disiram cream cheese mousse vanilla, saus selai Biscoff karamel lumer, dan topping biskuit utuh di atasnya.', 'Cream cheese lembut dipadu lelehan spread Lotus Biscoff', 49000, 55000, 'https://images.unsplash.com/photo-1587314168485-3236d6710814?auto=format&fit=crop&w=600&q=80', 'Favorit 💖', 'Tahan 5 hari dalam kulkas, 2 minggu dalam freezer.', 1, 1726500000000),
...
('p5', 'cat_fruity', 'Fresh Strawberry Shortcake Box', 'fresh-strawberry-shortcake', 'Vanilla sponge selembut awan dilapisi chantilly cream ringan dan potongan buah stroberi segar lokal yang manis-segar.', 'Potongan stroberi segar & fresh vanilla chantilly cream', 46000, 52000, 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?auto=format&fit=crop&w=600&q=80', 'Segar & Manis 🍓', 'Sangat disarankan langsung dihabiskan dalam 2 hari.', 1, 1726500000000),
